      ...
      <Animated.View style={[styles.panel, animatedStyle]}>
        <TouchableWithoutFeedback onPress={closePanel}>
          <View style={styles.panelContent}>
            ...
            <TouchableOpacity onPress={() => console.log("Botón dentro del panel presionado")} style={styles.panelButton}>
              <Text style={styles.panelButtonText}>Iniciar sesión</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => console.log("Botón dentro del panel presionado")} style={styles.panelButton2}>
